if(typeof document!=='undefined'&&!document.querySelector('link[data-claude-presentation]')){
 const link=document.createElement('link');link.rel='stylesheet';link.href='/67park-kimi-party/app/claude-presentation.css?v=20260914';link.dataset.claudePresentation='1';document.head.append(link);
}
