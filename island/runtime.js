...
import {shortenKimiRightTip} from '/67park-kimi-party/app/kimi-right-curb-tip.js?v=coast-20a';
import {installIslandSwimBoundary} from '/67park-kimi-party/app/island-swim-runtime.js?v=fleet-38';
import {installParcelGapQA} from '/67park-kimi-party/app/parcel-gap-qa.js';
import {applyParcelPaving} from '/67park-kimi-party/app/island-parcel-paving.js';
import {installParcelCornerQA} from '/67park-kimi-party/app/parcel-corner-qa.js';
import {assetFetch} from '/67park-kimi-party/app/entry-loading.js';
const islandFetch=(u,...a)=>assetFetch(typeof u==='string'&&u.startsWith('./')?'/67park-kimi-party/island/'+u.slice(2):u,...a);
...
import {repairIslandStairs,stairAt,stairsRailBlocked} from '/67park-kimi-party/app/island-stair-geometry.js';
import {applyCurbJoins} from '/67park-kimi-party/app/island-curb-joins.js';
import {applyParkEdges} from '/67park-kimi-party/app/island-park-edges.js';
...
import {shortenSoutheastDivider49} from '/67park-kimi-party/app/southeast-divider-49.js?v=corner-49b';
...
import {entryStage} from '/67park-kimi-party/app/entry-loading.js';
...
const GLB_DOSYASI=urlParams.get('model')==='pending'
  ...
  : '/67park-kimi-party/island/ada_calisma.glb';
