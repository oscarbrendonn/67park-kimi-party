...
import {mergeGeometries} from '/67park-kimi-party/island/utils/BufferGeometryUtils.js';
...
export async function loadCityProps59({scene,renderer,sample,variant}){
 ...
 const [buildings,bridge,layout,bridgeMeta]=await Promise.all([
  loader.loadAsync('/67park-kimi-party/island/city-buildings-v59.glb?v=1'),loader.loadAsync('/67park-kimi-party/island/city-bridge-v58.glb?v=1'),
